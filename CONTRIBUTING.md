...
Discussion around mu-scala-examples happens in the [Gitter channel](https://gitter.im/47deg/mu-scala-examples) as well as on
[GitHub issues](https://github.com/47deg/mu-scala-examples/issues) and [pull requests](https://github.com/47deg/mu-scala-examples/pulls).

Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about
the code. Pull requests are also welcome.

People are expected to follow the [Scala Code of Conduct](https://typelevel.org/code-of-conduct.html) when discussing mu-scala-examples on the Github page, Gitter channel, or other venues.
...
mu-scala-examples follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
